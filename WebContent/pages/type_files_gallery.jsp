...
<%@ include file="head_sidebar.jsp" %>
    ...
    <div class="content">
        ...
        <div class="ltt-container-fluid">
			...
			<div class="row-fluid ltt-actionbar" >
				  <button type="button" hidden="true" id="btn_upload"> <span class="icon-upload-alt"></span> 上传 </button>
				  ...
				  <button type="button" hidden="true" onclick="javascript:addFolder()"> <span class="icon-plus"></span> 新建文件夹 </button>
			...
			<div class="row-fluid ltt-pathbar">
				...
				<form id="list_form" method="post" action="TypeFileInListIndexAction.action">
	...
	<script src="/HTP/pages/project_js/type_files_gallery.js"></script>
