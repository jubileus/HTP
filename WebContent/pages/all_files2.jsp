    ...
    <div class="content">
        ...
        <div class="ltt-container-fluid">
			...
			<div class="row-fluid ltt-actionbar" >
				  ...
				  <button type="button" class="btn btn-default"> <span class="icon-refresh"></span> </button>
            ...
            <div id="pad-wrapper" class="gallery" >
                ...
                <div class="gallery-wrapper" >
                    <div class="gallery-row">
                       <!-- single image -->
                        <div class="folder_item span1 img-container" id="file_1">							         
							<div class="img-box">
								<span class="ltt-icon" >
									<i class="gallery-check" onclick="javascript:check_item(this.id)" id="check_1"></i>
								</span>  
                                <img src="/HTP/pages/img/icon/icon_folder.png" />
                                <div id="file_name_1">
                                	<div id="name_1">实训文档</div>
                                </div>
                            </div>							
                        </div>
            		</div>
