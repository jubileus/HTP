...
public class TypeFileInGalleryAction extends ActionSupport{
	private int total_page;
	private int index;
	private int category;
	private String search_name;
	private List<GalleryFileEntity> file_list;
	...
	public String execute() throws Exception {
        ...
        file_list=file_service.convertToGalleryFileEntity(tmp_list, img_map);
	...
	public List<GalleryFileEntity> getFile_list() {
		return file_list;
	}

	public void setFile_list(List<GalleryFileEntity> file_list) {
